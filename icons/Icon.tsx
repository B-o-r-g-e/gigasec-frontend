...
export const Icon = ({ name, size = 24, color = "currentColor" }: IconProps) => {
    const paths: Record<IconName, JSX.Element> = {
        ...
        eyeOff:   <><path d="M17.94 17.94A10.94 10.94 0 0112 20C5 20 1 12 1 12a21.8 21.8 0 015.08-6.62M9.9 4.24A11.6 11.6 0 0112 4c7 0 11 8 11 8a21.7 21.7 0 01-3.18 4.58" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round"/><line x1="1" y1="1" x2="23" y2="23" stroke={color} strokeWidth="2" strokeLinecap="round"/></>,
        ...
        trash:    <><polyline points="3 6 5 6 21 6" stroke={color} strokeWidth="2" strokeLinecap="round" fill="none"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6" fill="none" stroke={color} strokeWidth="2"/><path d="M10 11v6M14 11v6" stroke={color} strokeWidth="2" strokeLinecap="round"/><path d="M9 6V4a1 1 0 011-1h4a1 1 0 011 1v2" fill="none" stroke={color} strokeWidth="2"/></>,
        ...
        paystack: <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.418 0-8-3.582-8-8s3.582-8 8-8 8 3.582 8 8-3.582 8-8 8zm-1-11h2v6h-2zm0-3h2v2h-2z" fill={color}/>,
        user:     <><circle cx="12" cy="8" r="4" fill="none" stroke={color} strokeWidth="2"/><path d="M4 21a8 8 0 0116 0" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round"/></>,
        ticket:   <path d="M3 9a2 2 0 012-2h14a2 2 0 012 2v2a2 2 0 010 4v2a2 2 0 01-2 2H5a2 2 0 01-2-2v-2a2 2 0 010-4V9z" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round"/>,
        settings: <><circle cx="12" cy="12" r="3" fill="none" stroke={color} strokeWidth="2"/><path d="M19.4 15a1.7 1.7 0 00.34 1.87l.06.06a2 2 0 01-2.83 2.83l-.06-.06a1.7 1.7 0 00-1.87-.34 1.7 1.7 0 00-1 1.55V21a2 2 0 01-4 0v-.09a1.7 1.7 0 00-1-1.55 1.7 1.7 0 00-1.87.34l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.7 1.7 0 005 15.04a1.7 1.7 0 00-1.55-1H3.4a2 2 0 010-4h.09a1.7 1.7 0 001.55-1A1.7 1.7 0 005 7.17l-.06-.06a2 2 0 012.83-2.83l.06.06A1.7 1.7 0 009.7 4a1.7 1.7 0 001-1.55V2.4a2 2 0 014 0v.09a1.7 1.7 0 001 1.55 1.7 1.7 0 001.87-.34l.06-.06a2 2 0 012.83 2.83l-.06.06A1.7 1.7 0 0019.4 9c.65.25 1.09.87 1.09 1.57v.09a2 2 0 010 4h-.09c-.7 0-1.32.44-1.55 1.09z" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></>,
        bell:     <><path d="M18 8a6 6 0 00-12 0c0 7-3 8-3 8h18s-3-1-3-8" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round"/><path d="M10 20a2 2 0 004 0" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round"/></>,
