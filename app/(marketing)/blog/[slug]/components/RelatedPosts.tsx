        ...
        <section ref={ref} className="py-16 sm:py-20" style={{background: "#fff"}}>
            <div className="max-w-7xl mx-auto px-5 sm:px-10">
                <div className={`${spaceMono.className}`}
                     style={{fontSize: 10, color: B.electric, letterSpacing: 3, marginBottom: 10}}>KEEP READING
                </div>
                <h2 className={`${syne.className} mb-8 sm:mb-10`} style={{
                    fontWeight: 800,
                ...
                <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {topRelated.map((p, i) => {
                        return (
                            <a key={p.title} href={`/blog/${slugify(topRelated[i].title)}`}
                               ...
                               style={{
                                ...
                                <div className="h-35 flex items-center justify-center"
                                    ...
                                    <div className="absolute inset-0" style={{
                                        backgroundImage: "linear-gradient(rgba(51,154,153,0.12) 1px,transparent 1px),linear-gradient(90deg,rgba(51,154,153,0.12) 1px,transparent 1px)",
                                        backgroundSize: "24px 24px"
                                    }}/>
                                    <span
                                        className={`${spaceMono.className} px-3 py-1 rounded-full absolute top-4 left-4`}
                                        style={{
                                            fontSize: 9,
                                            background: "rgba(51,154,153,0.4)",
                                            color: "#fff",
                                            letterSpacing: 1.5
                                        }}>{p.cat}</span>
                                </div>
                                <div className="p-5">
                                    <h3 className={`${syne.className} mb-3 transition-colors duration-300`} style={{
                                        fontWeight: 700,
                                        fontSize: 15,
                                    ...
                                    <div className={`${dMSans.className} flex items-center gap-3`}
                                         style={{fontSize: 12, color: hov ? "rgba(255,255,255,0.5)" : B.gray}}>
