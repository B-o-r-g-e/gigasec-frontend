        ...
        <section ref={ref} className="bg-white py-[100px]">
            <div className="mx-auto max-w-[1280px] px-8">
                <div className="grid items-center gap-20 md:grid-cols-2">
                    ...
                    >
                        <div className="relative overflow-hidden rounded-[24px] bg-[linear-gradient(135deg,#003366_0%,#004080_100%)] p-12">
                            <div className="absolute -right-10 -top-10 h-[200px] w-[200px] rounded-full bg-[rgba(0,153,204,0.12)]" />

                            <div className="mb-5 font-['Space_Mono',monospace] text-[10px] tracking-[3px] text-[#0099CC]">
                                GIGASEC ADVANTAGE
                            </div>
                    ...
                    <span className="font-['DM_Sans',sans-serif] text-[13px] text-white/70">
                      {label}
                                        ...
                                        <span className="font-['Space_Mono',monospace] text-[12px] text-[#0099CC]">
                      {pct}%
                    </span>
                                    </div>
                                    ...
                                    <div className="h-1 rounded-[2px] bg-white/10">
                                        <div
                                            className="h-full rounded-[2px] bg-[linear-gradient(90deg,#0099CC,#66ccff)] transition-all duration-[1200ms] ease-out"
                                            style={{
                                                width: inView ? `${pct}%` : "0%",
                    ...
                    >
                        ...
                        <h2 className="mb-5 font-['Syne',sans-serif] text-[clamp(1.8rem,3.5vw,2.8rem)] font-extrabold tracking-[-0.5px] text-[#003366]">
                        ...
                        <div className="flex flex-col gap-5">
                            {points.map((p, i) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="mb-1 font-['Syne',sans-serif] text-[16px] font-bold text-[#003366]">
                                            {p.title}
                                        </div>
